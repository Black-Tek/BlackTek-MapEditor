...
#define EVT_ON_UPDATE_MENUS(id, fn) \
    DECLARE_EVENT_TABLE_ENTRY(      \
        EVT_UPDATE_MENUS, id, wxID_ANY, (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxCommandEventFunction, &fn), (wxObject*)nullptr),

#define EVT_ON_UPDATE_ACTIONS(id, fn) \
    DECLARE_EVENT_TABLE_ENTRY(        \
        EVT_UPDATE_ACTIONS, id, wxID_ANY, (wxObjectEventFunction)(wxEventFunction)wxStaticCastEvent(wxCommandEventFunction, &fn), (wxObject*)nullptr),
